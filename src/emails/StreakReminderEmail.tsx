...
export default function StreakReminderEmail({ locale, streak, appUrl }: StreakReminderEmailProps) {
  const t = emailStrings[locale].streakReminder;

  return (
    <EmailLayout previewText={t.preview} locale={locale}>
      <Heading style={{ fontSize: 22, margin: "0 0 12px", color: "#0f172a" }}>
        {t.heading(streak)}
      </Heading>

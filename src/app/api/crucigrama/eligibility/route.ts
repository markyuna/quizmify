...
export async function GET() {
  ...
  // True only for a Pro who hasn't yet completed their one free Crucigrama
  // today (UserDailyFreeGame row is written on completion). Always false for
  // free users -- they never get the free slot.

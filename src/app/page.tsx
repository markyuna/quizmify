            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Button asChild size="xl">
                <Link href={session?.user ? "/quiz" : "/login"}>
                  {session?.user ? t("ctaCreateQuiz") : t("ctaGetStarted")}
        ...
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
          <Card className="transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <h3 className="mt-4 text-xl font-semibold text-slate-900 dark:text-white">{t("featureAiTitle")}</h3>
          ...
          <Card className="transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <h3 className="mt-4 text-xl font-semibold text-slate-900 dark:text-white">{t("featureTrackTitle")}</h3>
              <p className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300">
                {t("featureTrackBody")}
              </p>
            </CardContent>
          ...
          <Card className="transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-6">
              ...
              <h3 className="mt-4 text-xl font-semibold text-slate-900 dark:text-white">{t("featureMistakesTitle")}</h3>
              <p className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300">
                {t("featureMistakesBody")}
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl bg-slate-50 p-6 dark:bg-white/5">
                <p className="text-sm text-slate-500 dark:text-slate-400">{t("statSetupLabel")}</p>
                <p className="mt-2 text-3xl font-bold text-slate-900 dark:text-white">{t("statSetupValue")}</p>
              </div>
              <div className="rounded-3xl bg-slate-50 p-6 dark:bg-white/5">
                <p className="text-sm text-slate-500 dark:text-slate-400">{t("statReviewLabel")}</p>
                <p className="mt-2 text-3xl font-bold text-slate-900 dark:text-white">{t("statReviewValue")}</p>
              </div>
              <div className="rounded-3xl bg-slate-50 p-6 dark:bg-white/5">
                <p className="text-sm text-slate-500 dark:text-slate-400">{t("statPracticeLabel")}</p>
                <p className="mt-2 text-3xl font-bold text-slate-900 dark:text-white">{t("statPracticeValue")}</p>
              </div>
              <div className="rounded-3xl bg-slate-50 p-6 dark:bg-white/5">
                <p className="text-sm text-slate-500 dark:text-slate-400">{t("statExperienceLabel")}</p>
                <p className="mt-2 text-3xl font-bold text-slate-900 dark:text-white">{t("statExperienceValue")}</p>
              </div>
            </div>
          </div>
        </div>
